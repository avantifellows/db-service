defmodule DbserviceWeb.TeacherController do
  ...
  def index(conn, params) do
    ...
    json(conn, DbserviceWeb.TeacherJSON.index(%{teacher: teacher}))
  end
  ...
  def show(conn, %{"id" => id}) do
    ...
    json(conn, DbserviceWeb.TeacherJSON.show(%{teacher: teacher}))
  end
  ...
  def update_teacher_with_user(conn, params) do
    ...
    with {:ok, %Teacher{} = teacher} <- Users.update_teacher_with_user(teacher, user, params) do
      conn
      |> put_status(:ok)
      |> json(DbserviceWeb.TeacherJSON.show(%{teacher: teacher}))
    end
  end
