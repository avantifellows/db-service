defmodule Dbservice.Repo.Migrations.AddIndexCutoffsDemographicProfileId do
  use Ecto.Migration
  ...
  # Index on cutoffs.demographic_profile_id (FK lookup).
  @disable_ddl_transaction true

  def change do
    create index(:cutoffs, [:demographic_profile_id], concurrently: true)
  end
end
