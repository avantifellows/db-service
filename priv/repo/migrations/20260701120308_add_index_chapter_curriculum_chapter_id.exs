defmodule Dbservice.Repo.Migrations.AddIndexChapterCurriculumChapterId do
  use Ecto.Migration
  ...
  # Index on chapter_curriculum.chapter_id (join table).
  @disable_ddl_transaction true

  def change do
    create index(:chapter_curriculum, [:chapter_id], concurrently: true)
  end
end
