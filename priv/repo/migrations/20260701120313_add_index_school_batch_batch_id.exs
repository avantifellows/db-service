defmodule Dbservice.Repo.Migrations.AddIndexSchoolBatchBatchId do
  use Ecto.Migration
  ...
  # Index on school_batch.batch_id (join table).
  @disable_ddl_transaction true

  def change do
    create index(:school_batch, [:batch_id], concurrently: true)
  end
end
