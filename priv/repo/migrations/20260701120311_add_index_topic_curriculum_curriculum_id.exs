defmodule Dbservice.Repo.Migrations.AddIndexTopicCurriculumCurriculumId do
  use Ecto.Migration
  ...
  # Index on topic_curriculum.curriculum_id (join table).
  @disable_ddl_transaction true

  def change do
    create index(:topic_curriculum, [:curriculum_id], concurrently: true)
  end
end
