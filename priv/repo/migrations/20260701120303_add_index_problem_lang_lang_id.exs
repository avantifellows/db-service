defmodule Dbservice.Repo.Migrations.AddIndexProblemLangLangId do
  use Ecto.Migration
  ...
  # Index on problem_lang.lang_id (hot path: every problem endpoint).
  @disable_ddl_transaction true

  def change do
    create index(:problem_lang, [:lang_id], concurrently: true)
  end
end
