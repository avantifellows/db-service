defmodule Dbservice.Repo.Migrations.AddIndexTopicCurriculumTopicId do
  use Ecto.Migration
  ...
  # Index on topic_curriculum.topic_id (join table).
  @disable_ddl_transaction true

  def change do
    create index(:topic_curriculum, [:topic_id], concurrently: true)
  end
end
