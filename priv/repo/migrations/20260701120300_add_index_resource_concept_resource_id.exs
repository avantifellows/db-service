defmodule Dbservice.Repo.Migrations.AddIndexResourceConceptResourceId do
  use Ecto.Migration
  ...
  # Index on resource_concept.resource_id (hot path: every problem render via ResourceJSON).
  @disable_ddl_transaction true

  def change do
    create index(:resource_concept, [:resource_id], concurrently: true)
  end
end
