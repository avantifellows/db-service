defmodule Dbservice.Repo.Migrations.AddIndexLearningObjectiveConceptId do
  use Ecto.Migration
  ...
  # Index on learning_objective.concept_id (FK lookup).
  @disable_ddl_transaction true

  def change do
    create index(:learning_objective, [:concept_id], concurrently: true)
  end
end
