defmodule Dbservice.Repo.Migrations.AddIndexResourceTeacherId do
  use Ecto.Migration
  ...
  # Index on resource.teacher_id (FK lookup).
  @disable_ddl_transaction true

  def change do
    create index(:resource, [:teacher_id], concurrently: true)
  end
end
