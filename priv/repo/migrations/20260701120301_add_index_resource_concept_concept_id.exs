defmodule Dbservice.Repo.Migrations.AddIndexResourceConceptConceptId do
  use Ecto.Migration
  ...
  # Index on resource_concept.concept_id (hot path: every problem render via ResourceJSON).
  @disable_ddl_transaction true

  def change do
    create index(:resource_concept, [:concept_id], concurrently: true)
  end
end
