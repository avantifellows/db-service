defmodule Dbservice.Repo.Migrations.AddIndexStudentExamRecordStudentId do
  use Ecto.Migration
  ...
  # Index on student_exam_record.student_id (FK lookup).
  @disable_ddl_transaction true

  def change do
    create index(:student_exam_record, [:student_id], concurrently: true)
  end
end
