defmodule Dbservice.Repo.Migrations.AddIndexStudentExamRecordExamId do
  use Ecto.Migration
  ...
  # Index on student_exam_record.exam_id (FK lookup).
  @disable_ddl_transaction true

  def change do
    create index(:student_exam_record, [:exam_id], concurrently: true)
  end
end
