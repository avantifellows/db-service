defmodule Dbservice.Repo.Migrations.AddIndexChapterCurriculumCurriculumId do
  use Ecto.Migration
  ...
  # Index on chapter_curriculum.curriculum_id (join table).
  @disable_ddl_transaction true

  def change do
    create index(:chapter_curriculum, [:curriculum_id], concurrently: true)
  end
end
