defmodule Dbservice.Repo.Migrations.AddIndexProblemLangResId do
  use Ecto.Migration
  ...
  # Index on problem_lang.res_id (hot path: every problem endpoint).
  @disable_ddl_transaction true

  def change do
    create index(:problem_lang, [:res_id], concurrently: true)
  end
end
