defmodule Dbservice.Repo.Migrations.AddIndexSchoolBatchSchoolId do
  use Ecto.Migration
  ...
  # Index on school_batch.school_id (join table).
  @disable_ddl_transaction true

  def change do
    create index(:school_batch, [:school_id], concurrently: true)
  end
end
