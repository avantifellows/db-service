defmodule Dbservice.Repo.Migrations.AddIndexResourceCurriculumCurriculumId do
  use Ecto.Migration
  ...
  # Index on resource_curriculum.curriculum_id (FK lookup).
  @disable_ddl_transaction true

  def change do
    create index(:resource_curriculum, [:curriculum_id], concurrently: true)
  end
end
