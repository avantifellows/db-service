defmodule SeedData.CollegeData do
  @moduledoc """
  Common college data source for seeding scripts.
  This module provides both detailed college data for the colleges table
  and a list of college names for candidate seeding.
  """

  @doc """
  Returns detailed college data for seeding the colleges table
  """
  def get_colleges_data do
    [
      # IITs
      %{
        college_id: "IIT001",
  ...
  @doc """
  Returns a list of college names for candidate seeding.
  Extracts names from the detailed college data and adds additional colleges.
  """
  def get_college_names do
    # Extract names from detailed college data
    detailed_college_names =
      get_colleges_data()
      |> Enum.map(& &1.name)

    # Additional colleges for variety in candidate seeding
    additional_colleges = [
      "Delhi University",
    ...
    detailed_college_names ++ additional_colleges
  end
end
